    ...
    <li class="list-group-item d-flex justify-content-between align-items-center">
        ...
        <div class="container text-center">
                <div class="row row-cols-4">
                    ...
                    <div class="col">:</div>
                    <div class="col-6"> {{ $jabatanPegawai }}</div>
                </div>
            </div>
        </li>
        <li class="list-group-item d-flex justify-content-between align-items-center">
        <div class="container text-center">
                <div class="row row-cols-4">
                    ...
                    <div class="col">:</div>
                    <div class="col-6"> {{ $nipPegawai }}</div>
                </div>
            </div>
        </li>
        <li class="list-group-item d-flex justify-content-between align-items-center">
        <div class="container text-center">
                <div class="row row-cols-4">
                    ...
                    <div class="col">:</div>
                    <div class="col-6">{{ $alamatPegawai }}</div>
                </div>
            </div>
        </li>
        <li class="list-group-item d-flex justify-content-between align-items-center">
        ...
        <div class="container text-center">
                <div class="row row-cols-4">
                    ...
                    <div class="col">:</div>
                    <div class="col-6"> {{ $gajiPegawai }} </div>
                </div>
            </div>
        </li>
    </ul> -->
